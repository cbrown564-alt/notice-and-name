...
**Category:** sensation  
**Asset:** `assets/images/concepts/illustrations/edging.png`  
...
| Field | Copy |
|-------|------|
| Definition | Intentionally approaching the edge of orgasm, then easing back before it happens - often repeated multiple times. |
| Illustrate caption | Intensity rising toward a threshold, then receding |
...
Pilot output path: `assets/images/concepts/illustrations/pilot/edging-{generator}.png`
