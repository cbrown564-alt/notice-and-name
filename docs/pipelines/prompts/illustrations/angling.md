# angling — Illustration

**Category:** technique  
**Asset:** `assets/images/concepts/illustrations/angling.png`  
...
| Field | Copy |
|-------|------|
| Definition | Rotating, raising, or lowering the pelvis during penetration to adjust where internal stimulation occurs. |
| Illustrate caption | How pelvic tilt redirects pressure along the anterior wall |
...
High-end gallery medical illustration demonstrating **Angling** (pelvic tilt). Side-by-side or ghosted overlay comparing neutral vs tucked pelvis—**no captions, titles, legends, or any text in the image** (prior pilot failed QA with labels). Side-view cross-section: show canal angle change and anterior-wall contact shift using **glow spots and curved arrows only** (no letter labels). Abstract phantom for trajectory, not explicit sex act. Warm tissue tones, respectful anatomy.
