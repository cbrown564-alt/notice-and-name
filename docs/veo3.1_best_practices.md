# Deprecated — Veo 3.1 best practices
...
The long-form Veo 3.1 report previously in this file is preserved in git history (`git log -- docs/veo3.1_best_practices.md`) if needed for comparison.
