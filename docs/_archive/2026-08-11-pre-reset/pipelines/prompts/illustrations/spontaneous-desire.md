# spontaneous-desire — Illustration

**Category:** timing  
**Asset:** `assets/images/concepts/illustrations/spontaneous-desire.png`  
...
| Field | Copy |
|-------|------|
| Definition | Sexual interest that arises on its own, without an external trigger - a seemingly random urge for sexual activity. |
...
Pilot output path: `assets/images/concepts/illustrations/pilot/spontaneous-desire-{generator}.png`
