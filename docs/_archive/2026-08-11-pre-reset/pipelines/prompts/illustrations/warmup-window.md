# warmup-window — Illustration

**Category:** timing  
**Asset:** `assets/images/concepts/illustrations/warmup-window.png`  
...
| Field | Copy |
|-------|------|
| Definition | The time needed for whole-body arousal before genital-focused stimulation feels best - often 20+ minutes. |
| Illustrate caption | Engorgement and blood flow increasing over time |
...
Split or transformation view of full clitoral structure. **State A (resting):** pale, smaller, less vascular. **State B (engorged):** swollen, rich coral/red vascular glow, “standing tall.” Visualize ~20-minute warm-up physiological change. Infographic clarity without labels in image.
...
Pilot output path: `assets/images/concepts/illustrations/pilot/warmup-window-{generator}.png`
