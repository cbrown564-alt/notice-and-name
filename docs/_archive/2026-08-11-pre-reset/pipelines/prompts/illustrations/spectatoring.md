# spectatoring — Illustration

**Category:** psychological  
**Asset:** `assets/images/concepts/illustrations/spectatoring.png`  
...
| Field | Copy |
|-------|------|
| Definition | Mentally watching and evaluating yourself during sex rather than staying present in the experience. |
| Illustrate caption | Attention split between body and inner critic |
...
Pilot output path: `assets/images/concepts/illustrations/pilot/spectatoring-{generator}.png`
